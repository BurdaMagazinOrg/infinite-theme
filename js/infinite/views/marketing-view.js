  ...
  BurdaInfinite.views.MarketingView = BaseView.extend(
    {
      ...
      onEnabledHandler: function(pModel) {
        ...
        this.enabled = !!pModel.get('marketingEnabled');
      },
      ...
      freeze: function() {
        ...
        if (
          this.visible &&
          height !== 0 &&
          this.adType !== MarketingView.CONTAINER_TYPE_SIDEBAR
        ) {
      ...
      getTargeting: function() {
        ...
        if ($adEntityContainer.length > 0)
          tmpTargeting =
            $adEntityContainer.attr('data-ad-entity-targeting') || null;
